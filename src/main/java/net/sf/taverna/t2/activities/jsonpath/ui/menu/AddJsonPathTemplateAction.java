...
public class AddJsonPathTemplateAction extends AbstractContextualMenuAction {
	...
	private static Logger logger = Logger
			.getLogger(AddJsonPathTemplateAction.class);

	public AddJsonPathTemplateAction() {
	...
	protected Action createAction() {
		...
		return new AddJsonPathAction();
	}
	
	protected class AddJsonPathAction extends AbstractAction {
		AddJsonPathAction () {
			super (ADD_JSONPATH, ActivityIconManager.getInstance().iconForActivity(
